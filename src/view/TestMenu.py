...
class TestMenu:
    ...
    def menu_loop(self):
        ...
        while warning is not None or not out:
            ...
            if inputted[0] == "leave":
                ...
                types_specified = None not in [pars.agent1, pars.agent2]
                agent1_coherent = pars.ml1 is not None if pars.agent1 == "ml" else True
                agent2_coherent = pars.ml2 is not None if pars.agent2 == "ml" else True
            ...
            # training parameters
                ...
                if inputted[1] in AGENTS_TYPE:
                    if inputted[0] == "agent1":
                        pars.agent1 = inputted[1]
                    else:
                        pars.agent2 = inputted[1]
                else:
    ...
    def display_parameters(self):
        pars = self.params
        contexts = [
            "agent1 type           : {}".format(pars.agent1),
            "agent2 type           : {}".format(pars.agent2),
